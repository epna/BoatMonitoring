...
public class listenningUDP extends IntentService {
    ...
    private void receiveUDP() {
        ...
        try {
            ...
            dataNavigation.trame= lText ;
            final Date temp = new Date();
            dataNavigation.lastupdate= temp;
            ...
            for (int i = 0; i < DataBoat.length - 1; i++) {
                ...
                dataNavigation.dataNavigation[Integer.parseInt ( Item[0] )][Integer.parseInt ( Item[1] )] = Float.parseFloat ( Item[2]) ;
            }
            sendMessage (""  );
